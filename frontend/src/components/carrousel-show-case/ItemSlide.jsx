...
const ItemSlide = () => {
    ...
    return (
      <div onClick={() => navigate('/learning/courseName?watch=AAAA')} className="w-[60vw] h-auto  sm:w-[240px] sm:h-[200px] md:w-[290px] md:h-[240px] lg:w-[350px] lg:h-[250px] p-2  rounded-md cursor-pointer  hover:bg-stone-50">
