...
import { FaUserGraduate, FaChalkboardTeacher, FaBook, FaChessKnight } from "react-icons/fa";
    ...
    <div className="relative h-full">
      ...
      <div className="m-auto max-w-[1200px] mt-3 min-h-[100vh]">
        ...
        <div className="mt-4 flex justify-evenly space-x-2">
          ...
          <div onClick={() => navigate("/admin/AdminNotification")}>
            <OptionCard
          ...
          <div onClick={() => navigate('/admin/games/')}>
            <OptionCard
              name="Manage Games"
              icon={<FaChessKnight />}
              color={"blue"}
