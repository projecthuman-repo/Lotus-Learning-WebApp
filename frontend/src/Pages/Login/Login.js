				...
				<div className="flex flex-col items-center justify-center">
					...
					<div className="w-[200px] flex flex-col items-center mt-10">
						...
						<div className=" flex items-center justify-center mt-[1.7rem] border-b-[.08rem] border-[#00000070] h-[40px] text-center tracking-wider text-lg md:text-2xl">
							...
							<Link to={"/signup"} className="w-[125px]  h-full cursor-pointer hover:text-zinc-500">
								Sign Up
							</Link>
						</div>
					</div>
					...
					<div className="w-[250px] flex flex-col justify-center items-center mt-12 ">
						...
						className="hover:border-zinc-300 focus:border-zinc-400 w-full border-b-[.08rem] py-1 focus:outline-none"type="text" placeholder="Email or Username"/>
						<input 
						value={password} onChange={(e) => {setPassword(e.target.value)}}
						className="hover:border-zinc-300 focus:border-zinc-400 w-full border-b-[.08rem] mt-3 py-1 focus:outline-none" type="text" placeholder="Password"/>
						<button 
						onClick={handleLogin}
					...
					<div className="w-[250px] flex flex-col items-center ">
							...
							<Link to={"/signup"} className="font-medium text-xs mt-2 text-center text-zinc-500 hover:text-zinc-600">
								Need an account? <span className="text-zinc-900 cursor-pointer">Create an acount</span>
							</Link>
					</div>
				</div>
			</div>
